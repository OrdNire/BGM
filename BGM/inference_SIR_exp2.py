...
if __name__ == '__main__':
    ...
    state = torch.load(os.path.join(args.model_path, "classification_model.pth"))
    ...
    SIR_inference_SIR2(args, model, indexing_model, label_embedding, query_loader, gallery_loader, logger, cfg)