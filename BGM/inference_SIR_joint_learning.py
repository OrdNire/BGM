...
from config_args import get_args_train_SIR, get_args_infer_SIR, get_args_infer_SIR_joint
...
args = get_args_infer_SIR_joint(argparse.ArgumentParser())
...
if __name__ == '__main__':
    ...
    # dataset
    query_loader, gallery_loader, _ = get_data(args)
    ...
    SIR_inference_exp1(args, model, None, label_embedding, query_loader, gallery_loader, logger, cfg)